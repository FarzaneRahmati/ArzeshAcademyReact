...
const WhyUs: FunctionComponent<WhyUsType> = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch [direction:rtl] shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] bg-white flex flex-row flex-wrap items-center justify-center py-[3.125rem] px-[2.5rem] gap-[1.25rem] text-center text-[1rem] text-title direction ${className}`}
    >
